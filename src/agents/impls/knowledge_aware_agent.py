...
# from src.capabilities.tools.builtin import (
...
#
#
# class KnowledgeAwareAgent(BaseAgent):
#     """知识感知智能体基类 - 集成知识库能力的智能体"""
#
#     def __init__(self, name: str, config: AgentFullConfig = None):
...
#                 from src.capabilities.tools.builtin import register_knowledge_tools
