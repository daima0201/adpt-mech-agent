...
class PromptAgent(BaseAgent):
    ...
    **K010: 基础版**
    *   **核心描述：** 主要提供核心量子加解密功能，为企业终端计算机上的商密文件进行加密防护和权限管控，适用于无文件集中存储管控需求的中小企业。功能包括：安全身份认证、文档加解密管理、文档属性标识与标识管理、审批管理及消息通知、系统后台管理。
    *   **业务场景：** 产品版本
    *   **关联产品：** 量子加密文件产品
    *   **关键词：** 基础版、核心加解密功能
    
    **K011: 高级版**
    *   **核心描述：** 在基础版上，增加文件的集中存储功能及相关的文档权限管控、安全分享、在线阅览功能。文档库存储空间为100G，密盘存储空间为1G。适用于有文件集中管控及外发文件管控需求的中小企业。功能在基础版基础上，增加文档细粒度权限管理、文档外发管控、文档库与密盘、密件收发与在线预览。
    *   **业务场景：** 产品版本
    *   **关联产品：** 量子加密文件产品
    *   **关键词：** 高级版、集中管控及权限控制
    
    **K012: 旗舰版**
    *   **核心描述：** 在高级版上，提供商密目录管理及辅助定密功能。文档库存储空间为200G，密盘存储空间为5G。适用于需要对商密文件进行全生命周期管控、建立标密规范并进行实时监控的大型企业。功能在高级版基础上，增加文档辅助定密、商业秘密目录、系统后台管理、商业秘密数据大屏展示。
    *   **业务场景：** 产品版本
    *   **关联产品：** 量子加密文件产品
    *   **关键词：** 旗舰版、全生命周期管控
    
    **K013: 产品资费**
    *   **核心描述：** 基础版标准资费为40元/月，高级版标准资费为60元/月，旗舰版标准资费为90元/月。
    *   **业务场景：** 产品报价
    *   **关联产品：** 量子加密文件产品
    *   **关键词：** 标准资费
    
    第二张表，我已将其整理为以下结构化的对话范例库，供后续调用。
